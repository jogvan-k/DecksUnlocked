...
namespace KeyforgeUnlocked.Cards.Logos.Creatures
{
    ...
    public class NeutronShark : CreatureCard
    {
        ...
        {
            s.Effects.Push(new TargetSingle((s, t, _) => s.Destroy(t), TargetType.Creature | TargetType.Artifact,
                Target.Own));
            s.Effects.Push(new TargetSingle((s, t, _) => s.Destroy(t), TargetType.Creature | TargetType.Artifact,
                Target.Opponens));
        };
        ...
        public NeutronShark(House house) : base(house, Power, Armor, Traits, playAbility: PlayFightReapAbility,
            fightAbility: PlayFightReapAbility, reapAbility: PlayFightReapAbility)
        {
        }
    }
}