...
namespace KeyforgeUnlocked.Effects
{
    public sealed class FightCreature : UseCreature<FightCreature>
    {
        ...
        protected override void SpecificResolve(IMutableState state, Creature fighter)
        {
            ...
            if (!targetCreature.CardKeywords.Contains(Keyword.Elusive) ||
                state.HistoricData.CreaturesAttackedThisTurn.Contains(new Identifiable(targetCreature)))
            {
            ...
            state.HistoricData.CreaturesAttackedThisTurn =
                state.HistoricData.CreaturesAttackedThisTurn.Add(new Identifiable(targetCreature));
            if (targetCreature.IsDead)
