...
namespace KeyforgeUnlocked.States
{
    public static class StateFactory
    {
            ...
            int? seed = null)
        {
            ...
            var metadata = new Metadata(initialDecks.ToReadOnly(kv => (IImmutableList<ICard>)kv.Value.Cards),
                houses.ToReadOnly(), 40, rngSeed);
            ...
            Deck player2Deck, int seed)
        {
            return new(new Dictionary<Player, IMutableStackQueue<ICard>>
            {
                ...
                }, //Shuffler.Shuffle(player1Deck.Cards, seed))},
                {
                    Player.Player2, new LazyStackQueue<ICard>(player2Deck.Cards)
                } //Shuffler.Shuffle(player2Deck.Cards, 2 * seed))}
            });
        }
