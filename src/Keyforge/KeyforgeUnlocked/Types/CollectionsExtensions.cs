...
namespace KeyforgeUnlocked.Types
{
  public static class CollectionsExtensions
  {
    ...
    public static ImmutableLookup<TKey, TValue> ToReadOnly<TKey, TValue>(this IDictionary<TKey, TValue> lookup) where TKey : notnull
    {
      return new(lookup);
    }
    
    public static ImmutableLookup<TKey, TValue> ToReadOnly<TKey, TValue>(this Lookup<TKey, TValue> lookup) where TKey : notnull
    {
      return new(lookup);
    }
  }
