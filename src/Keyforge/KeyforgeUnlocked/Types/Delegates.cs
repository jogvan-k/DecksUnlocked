...
namespace KeyforgeUnlocked.Types
{
    ...
    {
        public static readonly Callback StunTarget = (s, t, _) => { s.StunCreature(t!); };

        public static Callback ReadyAndUse(UseCreature allowedUsage = UseCreature.All) => (s, c, _) =>
            s.AddEffect(new ReadyCreatureAndUse(c!, true, allowedUsage));
