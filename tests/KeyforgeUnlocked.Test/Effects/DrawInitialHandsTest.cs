...
namespace KeyforgeUnlockedTest.Effects
{
    ...
    class DrawInitialHandsTest
    {
        ...
        public void Resolve()
        {
            ...
            var startDecks = new Dictionary<Player, IMutableStackQueue<ICard>>
                { { Player.Player1, startDeck1 }, { Player.Player2, startDeck2 } }.ToImmutableDictionary();
            ...
            {
                new CardsDrawn(Player.Player1, FirstPlayerStartHand),
                new CardsDrawn(Player.Player2, SecondPlayerStartHand)
            };
