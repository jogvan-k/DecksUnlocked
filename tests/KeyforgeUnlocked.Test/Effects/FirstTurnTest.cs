...
namespace KeyforgeUnlockedTest.Effects
{
    ...
    class FirstTurnTest
    {
        readonly ICreatureCard[] LogosCreatureCards =
            { new SampleCreatureCard(house: House.Logos), new SampleCreatureCard(house: House.Logos) };
        ...
        readonly ICreatureCard[] UntamedCreatureCards =
            { new SampleCreatureCard(house: House.Undefined), new SampleCreatureCard(house: House.Undefined) };
            ...
            {
                {
                    Player.Player1,
                    new LazySet<ICard>(
                        LogosCreatureCards.Concat(StarAllianceCreatureCards).Concat(UntamedCreatureCards))
                },
