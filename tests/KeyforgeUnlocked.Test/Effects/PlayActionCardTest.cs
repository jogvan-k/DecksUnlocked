...
namespace KeyforgeUnlockedTest.Effects
{
    ...
    sealed class PlayActionCardTest
    {
        ...
        public void Resolve_CardWithAemberPips()
        {
            ...
            var expectedState = StateTestUtil.EmptyState.New(aember: expectedAember, discards: expectedDiscards,
                resolvedEffects: new LazyList<IResolvedEffect>(expectedResolvedEffects), events: events);
            StateAsserter.StateEquals(expectedState, state);
            Assert.True(playCardEventRaised);
        }
        ...
        [Test]
        public void Resolve_CardsWithUnimplementedPips_NotImplementedException(
            [Values(Pip.Capture, Pip.Damage, Pip.Draw)] Pip pip)
        {
