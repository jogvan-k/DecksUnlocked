...
namespace KeyforgeUnlockedTest.Effects
{
    ...
    class ReadyCardsAndRestoreArmorTest
    {
            ...
            Player playerTurn)
        {
            ...
            {
                new CreatureReadied(new Creature(playerTurn.IsPlayer1() ? playerCreatureCard2 : opponentCreatureCard2,
                    isReady: true))
            };
            ...
            Player playerTurn)
        {
            ...
            var expectedArtifacts = TestUtil.Sets(
                new[] { new Artifact(player1Artifact1, playerTurn.IsPlayer1()), new Artifact(player1Artifact2, true) }
                    .AsEnumerable(),
                new[] { new Artifact(player2Artifact1, true), new Artifact(player2Artifact2, playerTurn.IsPlayer2()) }
                    .AsEnumerable());
